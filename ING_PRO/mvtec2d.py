...
class MVTec2D(Dataset):
    ...
    def __getitem__(self, idx):
        img_src, label, mask, task_id = self.imgs_list[idx], self.labels_list[idx], self.masks_list[idx], \
        self.task_ids_list[idx]
    ...
    def load_dataset(self):
        ...
        self.class_in_task = [self.class_name[self.num_task - 1]]
        # get data
        x, y, mask = [], [], []
        for class_name in self.class_in_task:
        ...
        task_id = [0 for i in range(len(x))]
